...
export function ConfirmPage({
  ...
  const transactionRows = [
    ...
    ["Selected Route", displayDecision.selectedRoute],
    ...
    <main className="flex min-h-screen items-center justify-center bg-[#f7fafc] px-6 py-6 dark:bg-[#0f172a]">
      <section className="flex w-full max-w-[730px] flex-col gap-4">
        ...
        <div className="mx-auto flex w-full max-w-sm flex-col gap-2">
          {displayVerdict.recommendedRoute !== "Block" ? (
            <button
              ...
              onClick={
                displayVerdict.recommendedRoute === "Direct Send"
                  ? onDirectSend
                  : onGuardedPayment
              }
              type="button"
            >
              <span className="material-symbols-outlined">
                {displayVerdict.recommendedRoute === "Direct Send" ? "send" : "shield"}
              </span>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              disabled={displayVerdict.recommendedRoute === "Block"}
